...
public:
	...
	static Mesh* generateRegularPolygon(GLuint num, GLdouble r, GLdouble posX = 0, GLdouble posY = 0);
	static Mesh* generateRGBTriangle(GLdouble r, GLdouble posX = 0, GLdouble posY = 0);
